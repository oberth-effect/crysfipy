...
class re:
    ...
    def _calculate(self):
        ...
        self.gJ = i.gJ
        self.moment = np.zeros((i.J2p1, 3),
                               float)  # matrix with projection of moments to x, y, z directions for all J2p1 levels
        ...
        self.moment[:, 0] = - i.gJ * np.real(
            diag(self.Jx))  # calculation of projections of moments for every eigenvector
...
def get_perpendicular_j(ion: re, h, k, l):
    """Calculates the J_(perpendicular) for specific reciprocal vector (h, k, l)"""
